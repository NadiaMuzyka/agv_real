...
class RedisInterface:
    ...
    def __new__(cls):
        ...
        """
        # If the instance does not exist, create it in a thread-safe manner
        if cls._instance is None:
            with cls._lock:
                # This ensures that only one instance is created even if multiple threads
                if cls._instance is None:
    ...
    def __init__(self):
        ...
        Returns:
            None.
        """
        # Forbids overwriting the connection if the instance already exists
